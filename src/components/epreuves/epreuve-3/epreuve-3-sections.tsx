    ...
    <div>
      <GlassCard className='mb-8' padding='p-6'>
        <p className='text-gray-300'>
          Le candidat dispose de <strong className='text-gray-200'>quarante minutes</strong> pour préparer un sujet{' '}
          <strong className='text-gray-200'>aléatoire</strong> : mise en situation façon enquête (esprit des dossiers{' '}
          <strong className='text-gray-200'>Alpha / Bravo</strong> du site). À l’issue du temps, passage devant{' '}
          <strong className='text-gray-200'>un magistrat et un commissaire</strong> : présentation du déroulé de l’enquête
          puis questions.
        </p>
      ...
      <div className='mb-8 grid gap-4 md:grid-cols-3'>
        {[
          { icon: Timer, title: 'Préparation (40 min)', desc: 'Analyser le sujet, cadre procédural et canevas d’exposé' },
          { icon: Phone, title: 'Oral devant le jury', desc: 'Déroulé de l’enquête : faits, actes, personnes, suites' },
          { icon: MessageCircle, title: 'Questions', desc: 'Magistrat et commissaire : précisions et contrôle technique' },
    ...
    <div className='space-y-10'>
      ...
      <div className='space-y-4'>
        ...
        <p className='flex items-start gap-2 text-sm text-amber-400'>
          ...
          <span>Préciser la section : majeur / mineur / criminelle</span>
        </p>
      </div>
