...
const links = [
  { id: 'articulation', label: 'Articulation de procédure' },
  { id: 'cartouches', label: 'Cartouches de PV' },
  { id: 'synthese', label: 'Rapport de synthèse' },
] as const;

export function Epreuve2StickyToc() {
