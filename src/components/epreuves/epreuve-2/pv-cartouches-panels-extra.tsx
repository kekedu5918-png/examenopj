...
import { PVCard, PVDivider, PVLine, PVNote } from './pv-card';
    ...
    <Accordion type='single' collapsible className='w-full'>
      <AccBlock id='pv-31' title='Interpellation sur la voie publique'>
        <PVCard>
          <div className='space-y-2'>
            <PVLine
              m='À … h : menottage'
              i={"si effectué et justifié — lieu d'interpellation — palpation"}
            />
      ...
      <AccBlock id='pv-32' title='Saisine, Interpellation de Prénom NOM'>
        <PVCard>
          <div className='space-y-2'>
            ...
            <PVLine m="Qualification de l'infraction avec CA." />
            <PVLine m='Cadre juridique.' />
            <PVLine m='Information verbale placement en GAV.' />
            <PVLine m='Menottage' i='seulement si effectué et justifié — palpation' />
      ...
      <AccBlock id='pv-33' title='Transport — Interpellation dans un domicile (Adresse)'>
        <PVCard>
          <div className='space-y-2'>
            <PVLine
              m='À … h : menottage, information verbale placement en GAV'
      ...
      <AccBlock id='pv-36' title='Perquisition au domicile de Prénom NOM, lieu'>
        <PVCard>
          <div className='space-y-2'>
            ...
            <PVLine m='Heure de début et heure de fin' i='obligatoire' />
            <PVLine
              m='Si découverte :'
