              ...
              {items.map((m) => (
                <li key={m.id}>
                  <Link
                    ...
                    className={cn(
                      'block rounded-xl border p-5 transition hover:border-cyan-500/30 hover:bg-white/[0.03] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400/60',
