...
const PHASES: Phase[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Éléments constitutifs et titres : base quotidienne de l’épreuve 1.',
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Tableaux comparatifs ; utile pour l’épreuve 1 et les révisions ciblées.',
      },
      {
        href: '/cours/enquetes',
        title: 'Enquêtes types formation',
        description: 'Alpha (gratuite) puis thèmes faibles : socle pour l’épreuve 2.',
      },
      {
        href: '/epreuves/epreuve-2',
        title: 'Méthode épreuve 2',
        description: 'Attentes des correcteurs : cartouches, forme et articulation.',
      },
    ],
  },
  {
    ...
    objective: 'Chronométrage, sujets blancs, oral enregistré : passer en mode « examen réel ».',
    cards: [
      {
        href: '/sujets-blancs',
        title: 'Sujets blancs complets',
        description: 'Les 3 épreuves en conditions réduites ; debrief immédiat.',
      },
      {
        href: '/entrainement/articulation',
        title: 'Articulation épreuve 2',
        description: 'Enchaînements qualification / procédure avec corrigés-types.',
      },
      {
        href: '/epreuves/epreuve-3',
        title: 'Préparation oral',
        description: 'Structure du compte-rendu et pièges du jury.',
      },
      {
