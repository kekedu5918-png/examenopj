...
export const recapSections: RecapSection[] = [
  recapSectionF01P1 as RecapSection,
  {
    ...
    rows: [
      ...
      },
      {
        ...
        legal: 'Art. 223-6 al. 2 (incrimination) / al. 1 (peine)',
        materiel:
    ...
    rows: [
      {
        ...
        legal: 'Art. 225-1, 225-1-1, 225-1-2, 225-2 C.P.',
        materiel:
      ...
      },
      {
        ...
        legal: 'Art. 225-6 C.P. (déf.) / Art. 225-5 C.P. (répression)',
        materiel:
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        legal: 'Art. 226-4-1 al. 1 et al. 2 C.P.',
        materiel:
      ...
      },
      {
        ...
        legal: 'Art. 226-15 al. 2 et al. 1 C.P.',
  ...
  },
  {
    ...
    rows: [
      {
        infraction: '**Le vol**',
        legal: 'Art. 311-1 C.P. (définit) / Art. 311-3 C.P. (réprime)',
