...
**ÉLÉMENT MORAL :** *volonté de conduire* en ayant consommé de l’alcool (intentionnelle — *Cass. crim.* 19/12/1994).`,
  ...
  ...pair(
    ...
    '*Art. L.234-1 / I du Code de la route* (état d’ivresse manifeste) — délit.',
...
**ÉLÉMENT MORAL :** conscience de ne pas être assuré.`,
  ...
  ...pair(
    ...
    '*Arts. L.317-1 à L.317-4 et L.317-4-1 du Code de la route* — gradation des peines selon hypothèses.',
    `**ÉLÉMENT MATÉRIEL :** circulation avec plaques absentes, d’un autre véhicule, falsifiées ou non conformes (selon articles visés).

**ÉLÉMENT MORAL :** volonté d’utiliser ou de faire circuler avec des mentions ou plaques non conformes.`,
    'NON',
    'OUI',
  ),
  ...pair(
...
**ÉLÉMENT MORAL :** volonté d’adopter cette conduite dangereuse de façon répétée.`,
  ...
  ...pair(
    ...
    '*Art. L.236-3 du Code de la route*.',
