...
export const FONDAMENTAUX_PART2: Fiche[] = [
  {
    ...
    tableau: {
      ...
      lignes: [
        ['Placer en GAV', 'Oui', 'Non', 'Non'],
        ['Perquisition (flagrance)', 'Oui', 'Non', 'Non'],
        ['Réquisitions art. 60', 'Oui', 'Oui (art. 60)', 'Non'],
        ['Audition sous GAV', 'Oui', 'Non', 'Non'],
        ['Constater une contravention', 'Oui', 'Oui', 'Oui'],
        ['Contrôle d\'identité', 'Oui', 'Oui', 'Oui (limité)'],
        ['Saisie / Scellés', 'Oui', 'Oui (sur ordre OPJ)', 'Non'],
      ],
    },
  },
  {
    ...
    regles: [
      ...
      {
        label: 'Attention — Caractéristiques',
        detail:
  ...
  },
  {
    ...
    regles: [
      ...
      {
        label: 'Attention — Formule PRQC pour l\'examen',
        detail:
  ...
  },
  {
    ...
    regles: [
      ...
      },
      {
        ...
        detail:
          'Motifs fondés sur l\'appartenance (vraie ou supposée) de la victime à une ethnie, nation, race ou religion. À démontrer en dernier lieu.',
        alerte: true,
      },
      {
        ...
        detail:
          'Fondés sur le sexe, l\'orientation sexuelle ou l\'identité de genre. À démontrer en dernier lieu.',
        alerte: true,
      },
      {
        label: 'Cryptologie',
  ...
  },
  {
    ...
    regles: [
      ...
      {
        label: 'Attention — Concours vs récidive',
        detail:
