...
export const metadata: Metadata = {
  title: 'Infractions',
  description: `${APP_NAME} : référentiel des infractions (thèmes personnes et biens du programme) — recherche, éléments légaux, matériel et moral. Préparation examen OPJ.`,
