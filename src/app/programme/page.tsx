...
export const metadata: Metadata = {
  title: 'Programme de révision OPJ',
  description: `${APP_NAME} : sommaire des 15 thèmes du programme (DPS, DPG, procédure), entraînement associé — contenu pédagogique original, aligné sur le programme officiel.`,
};
