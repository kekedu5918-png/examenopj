...
export const metadata: Metadata = {
  title: 'Les 3 épreuves — Vue d’ensemble | Examen OPJ',
  description:
...
const epreuves = [
  ...
  },
  {
    ...
    num: '3',
    titre: 'Oral — compte-rendu parquet',
    duree: 'Préparation limitée',
    focus: 'Clarté, hiérarchie de l’information, crédibilité OPJ',
    icon: Mic,
    attendus: [
      'Structurer comme un compte-rendu opérationnel : faits → actes → personnes → suites / demandes.',
      'Ton professionnel, faits vérifiables, pas de procès d’intention.',
      'Anticiper les questions du magistrat (garanties procédurales, choix juridiques).',
    ],
