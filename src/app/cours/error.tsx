...
export default function CoursError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
  ...
  return (
    <div className='flex min-h-[50vh] flex-col items-center justify-center px-4 py-16 text-center'>
      ...
      <p className='mt-2 max-w-sm text-sm text-gray-400'>
        Le contenu du cours n&apos;a pas pu être chargé. Vérifiez votre connexion et réessayez.
      </p>
