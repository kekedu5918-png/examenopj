  ...
  theme: {
    ...
    extend: {
      colors: {
         ...
         */
        ij: {
          /** Triplets dans globals.css — opacité Tailwind v3 via rgb(var(...) / <alpha-value>) */
          bg: 'rgb(var(--ij-bg) / <alpha-value>)',
          surface: 'rgb(var(--ij-surface) / <alpha-value>)',
          'surface-2': 'rgb(var(--ij-surface-2) / <alpha-value>)',
          border: 'rgb(var(--ij-border) / <alpha-value>)',
          'border-strong': 'rgb(var(--ij-border-strong) / <alpha-value>)',
          text: 'rgb(var(--ij-text) / <alpha-value>)',
          'text-muted': 'rgb(var(--ij-text-muted) / <alpha-value>)',
          'text-subtle': 'rgb(var(--ij-text-subtle) / <alpha-value>)',
          primary: 'rgb(var(--ij-primary) / <alpha-value>)',
          accent: 'rgb(var(--ij-accent) / <alpha-value>)',
          'accent-soft': 'rgb(var(--ij-accent-soft) / <alpha-value>)',
