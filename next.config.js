...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/enquetes', destination: '/entrainement/enquetes', permanent: true },
      { source: '/cours/enquetes', destination: '/entrainement/enquetes', permanent: true },
      { source: '/cours/enquetes/:slug', destination: '/entrainement/enquetes/:slug', permanent: true },
      { source: '/programme', destination: '/cours', permanent: true },
      { source: '/fondamentaux/:path*', destination: '/cours', permanent: true },
      { source: '/cours/modules/:path*', destination: '/cours', permanent: true },
      { source: '/cours/pv/:path*', destination: '/cours', permanent: true },
      { source: '/cours/modeles-pv/:path*', destination: '/cours', permanent: true },
      { source: '/cours/infractions', destination: '/infractions', permanent: true },
      { source: '/fascicules', destination: '/cours', permanent: true },
      { source: '/fascicules/:id', destination: '/cours', permanent: true },
